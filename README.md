...
> **Compatibility:** v1.5.5 is certified only with DeepSeek Harness `0.1.0-rc.6`, Cordis `4.0.1`, Node.js 22+, and Git. Future Harness release candidates are not covered until tested.
...
dsh plugin --profile web add dsh-project-orchestrator@1.5.5
```
